...
const Input = ({ placeholder, name, type, value, handleChange }) => (
    <input type="text" placeholder={placeholder} type={type} step="0.0001" value={value} onChange={(e) => handleChange(e, name)} className='my-2 w-full rounded-sm p-2 outline-none bg-transparent text-white border-none text-sm white-glassmorphism' />
);
        ...
        <div className="flex w-full justify-center items-center">
            <div className="flex mf:flex-row flex-col items-start justify-between mf:p-20 py-12 px-4">
                <div className="flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className='text-left mt-5 text-white font-light mf:w-9/12 w-11/12 text-base'>Explore the crypto world, buy and sell cryptocurrencies easily on Cryptbits</p>
                    {!currentAccount && (
